...
class Movie < ActiveRecord::Base
  ...
  scope :by_domestic, -> { where('boxoffice_us NOT NULL').order('boxoffice_us DESC') }
  scope :by_worldwide, -> { where('boxoffice_worldwide NOT NULL').order('boxoffice_worldwide DESC') }
